      ...
      Object.keys(donationForm).forEach(key => {
        if (key === 'coordinates') {
          formData.append('location', JSON.stringify({
            ...
            coordinates: donationForm.coordinates
          }));
            ...
            <div className="chat-container">
              <div className="chat-messages">
                {chatMessages.length === 0 && (
                  <div className="welcome-message">
                    <p>👋 Hi! I'm your AI assistant for leftover recipes!</p>
                    <p>I can help you with:</p>
                    <ul>
                      <li>🍳 Recipe suggestions for your leftovers</li>
                      <li>📊 Nutritional information</li>
                      <li>🥫 Food storage tips</li>
                      <li>♻️ Ways to reduce food waste</li>
                    </ul>
              ...
              <form onSubmit={handleChatSubmit} className="chat-input-form">
                <input 
                  ...
                  placeholder="Ask me about leftover recipes..."
