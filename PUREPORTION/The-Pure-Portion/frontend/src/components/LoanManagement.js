...
const LoanManagement = () => {
  ...
  const fetchLoans = async () => {
    try {
      ...
      const response = await axios.get("/api/finance/loans", {
  ...
  const createLoan = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await axios.post("/api/finance/loans", loanForm, {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const processPayment = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `/api/finance/loans/${selectedLoan._id}/payment`,
        paymentForm,
        { headers: { Authorization: `Bearer ${token}` } }
      );
                ...
                <tr key={loan._id}>
                  ...
                  <td>
                    <div className="staff-info">
                      <img
                        src={loan.staffId?.profileImage ? `/uploads/staff-images/${loan.staffId.profileImage}` : "https://via.placeholder.com/40"}
              ...
              <div className="form-group">
                ...
                <div className="staff-tiles">
                  {staffList.map(staff => (
                    ...
                    >
                      <img
                        src={staff.profileImage ? `/uploads/staff-images/${staff.profileImage}` : "https://via.placeholder.com/60"}
