...
const { parseRecipeUpload } = require('../controllers/recipeParseController');
...
// Memory-storage multer for AI parse endpoint (needs buffer, not disk file)
...
// AI recipe parse endpoint (text / PDF / image → extracted ingredients + inventory matches)
router.post('/parse-upload', memUpload.single('file'), parseRecipeUpload);
